...
parameters <- c(
  ...
  Em_0   = 0.0195 / day * tunit   , # [d-1] Enzyme turnover rate (Allison at al. 2010) (!uncertain!). Value for 290K.
  Mm_0   = 0.0054 / day * tunit   , # [d-1] Microbe turnover rate (Allison at al. 2010) (!uncertain!). Value for 290K.
#   V_D_0  = 2.5 / day * tunit      , # [d^-1] Maximum speed ofRC decomposition of PC (Tang and Riley 2014) !uncertain!
  V_D_0  = 24 / day * tunit       , # [d^-1] Maximum speed of PC decomposition (Allison at al. 2010) !uncertain!
#   V_U_0  = 10.93 / day * tunit    , # [d^-1] Maximum speed of microbial uptake of SC (Tang and Riley). Use only if MC is scaled with transporter desnity!!!
  V_U_0  = 0.01 / day * tunit     , # [d^-1] Maximum speed of microbial uptake of SC (Allison at al. 2010) Use without t_M scaling!!!
...
#   t_MC     = 0.05    , # [g g^-1] scalar for transporter as fraction of MC (Tang and Riley 2014)
  T0       = 290     , # [K] reference temperature
  E_V.U    = 45000   , # [J mol^-1]  Gibbs energy for V_U (Tang and Riley 2014)
  E_V.D    = 45000   , # [J mol^-1]  Gibbs energy for V_D (average of lignin and cellulose in Wang et al. 2013)
  E_K.U    = 15000   , # [J mol^-1]  Gibbs energy for K_U (Tang and Riley 2014)
  E_K.D    = 15000   , # [J mol^-1]  Gibbs energy for K_D (Tang and Riley 2014)
