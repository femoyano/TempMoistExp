...
### Documentation ==============================================================
# Main program file.
# Soil model: SCM_dry.zones

# Simulation of soil C dynamics. This is the main R script that runs the model.

# Branch = dry_zones: here the soil moisture modifies the amount of each component 
# (e.g. M, LC, RC) present in the water phase and thus able to react. The dry 
# fractions are (almost) entirely inactive and immobile.
