...
pars_optim <- c(
  ...
  f_CA      = 0.7    , # both soils (bare fallow and maize(Closeaux)) has the same fraction of clay+silt to total C
  f_CD      = 0.001  , #
  f_CEm     = 0.001  , #
  f_CEw     = 0.001  , #
  f_CM      = 0.01   , #
  ...
  E_V       = 47     , # [kJ mol^-1] Gibbs energy for decomposition
  ...
  d_pm      = 1e-5   , # [m] characteristic distance between substrate and microbes (Manzoni manus)
