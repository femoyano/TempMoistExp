...
site.data.mz  <- read.csv(file.path("..", "Data", "NadiaTempMoist", "site_Closeaux.csv"))
site.data.bf  <- read.csv(file.path("..", "Data", "NadiaTempMoist", "site_BareFallow42p.csv"))
...
source("pars_optim.R")
source("pars_optim_lower.R")
source("pars_optim_upper.R")
