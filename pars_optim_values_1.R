...
pars_optim_upper <- c(
  ...
  E_V       = 70     , # [kJ mol^-1] Gibbs energy for decomposition and turnover times
  ...
  D_d       = 1e-2  / sec  * tstep , # [m2 s-1] Diffusivity in water for amino acids, after Jones et al. (2005); see also Poll et al. (2006). (Manzoni paper)
