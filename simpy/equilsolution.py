...
Version 2. Equations are simplified
"""
...
sol_A0M0F1S1 = sy.solve([dC_p, dC_d, dC_ew, dC_em],
                        [C_p, C_d, C_ew, C_em], dict=True)
sol_A0M0F1S1 = sol_A0M0F1S1[0]
sol_C_p = sol_A0M0F1S1[C_p]
sol_C_d = sol_A0M0F1S1[C_d]
sol_C_em = sol_A0M0F1S1[C_em]
sol_C_ew = sol_A0M0F1S1[C_ew]
